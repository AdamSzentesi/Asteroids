...
public class InputSubsystem extends Subsystem
{
	...
	public InputSubsystem()
	{
		...
		this.keyNames.put(0x10, "KEY_Q");
		this.keyNames.put(0x11, "KEY_W");
		this.keyNames.put(0x12, "KEY_E");
		this.keyNames.put(0x13, "KEY_R");
		this.keyNames.put(0x14, "KEY_T");
		this.keyNames.put(0x15, "KEY_Y");
		this.keyNames.put(0x16, "KEY_U");
		this.keyNames.put(0x17, "KEY_I");
		this.keyNames.put(0x18, "KEY_O");
		this.keyNames.put(0x19, "KEY_P");
		
		this.keyNames.put(0x1E, "KEY_A");
		this.keyNames.put(0x1F, "KEY_S");
		this.keyNames.put(0x20, "KEY_D");
		this.keyNames.put(0x21, "KEY_F");
		this.keyNames.put(0x22, "KEY_G");
		this.keyNames.put(0x23, "KEY_H");
		this.keyNames.put(0x24, "KEY_J");
		this.keyNames.put(0x25, "KEY_K");
		this.keyNames.put(0x26, "KEY_L");
		
		this.keyNames.put(0x39, "KEY_SPACE");
	
		this.keyNames.put(0xC8, "KEY_UP");
		this.keyNames.put(0xCB, "KEY_LEFT");
		this.keyNames.put(0xCD, "KEY_RIGHT");
		this.keyNames.put(0xD0, "KEY_DOWN");
	}
