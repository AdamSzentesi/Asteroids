...
public class QuadtreeAABB
{
	...
	public QuadtreeAABB(int level, int MAX_OBJECTS, Vector2f leftBottomCorner, float width, float height)
	{
		this.level = level;
	...
	public QuadtreeAABB(int MAX_OBJECTS, Vector2f leftBottomCorner, float width, float height)
	{
	...
	public void insert(Physics2DAABB box, int value)
	{
		...
		{
			insert(new Physics2DAABB(nodeToRedistribute.min, nodeToRedistribute.max), nodeToRedistribute.value);
		}
